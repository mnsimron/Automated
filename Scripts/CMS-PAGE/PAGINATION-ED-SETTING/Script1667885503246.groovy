...
WebUI.click(findTestObject('Object Repository/Page_CMS APL/a_Next'))

WebUI.click(findTestObject('Object Repository/Page_CMS APL/a_Previous'))

WebUI.click(findTestObject('Object Repository/Page_CMS APL/a_4'))
