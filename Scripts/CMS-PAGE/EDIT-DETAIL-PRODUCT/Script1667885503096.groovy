...
WebUI.setText(findTestObject('Object Repository/Page_CMS APL/div_Rendy Testing 123'), 'Rendy Testing 123')

WebUI.click(findTestObject('Object Repository/Page_CMS APL/button_Edit Product'))
