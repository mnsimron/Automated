...
WebUI.click(findTestObject('Object Repository/Page_eZRX  Login page/div_Login'))
...
WebUI.click(findTestObject('Object Repository/Page_CMS APL/td_Set Date_dt-checkboxes-cell sorting_1_1'))
