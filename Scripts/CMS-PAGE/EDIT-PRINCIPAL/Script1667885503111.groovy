...
WebUI.click(findTestObject('Object Repository/Page_CMS APL/a_Lihat Detail'))

WebUI.click(findTestObject('Object Repository/Page_CMS APL/a_Edit'))

WebUI.setText(findTestObject('Object Repository/Page_CMS APL/textarea_Nama Prinsipal0000000'), 'Nama Prinsipal123')

WebUI.click(findTestObject('Object Repository/Page_CMS APL/input_Remove_btnEdit'))
