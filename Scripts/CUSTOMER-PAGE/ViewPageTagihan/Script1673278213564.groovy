...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Tagihan'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/li_Pembayaran'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/button_Retur 1'))
