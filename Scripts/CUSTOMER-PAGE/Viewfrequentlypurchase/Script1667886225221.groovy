...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/form_Syarat dan KetentuanIngat Saya (Opsion_0c9c44'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/button_MASUK'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/label_Syarat dan Ketentuan harus dicentang__559278'))
