...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/span_Select'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/div_ABBOTT CARDIOMETABOLIC'))
