...
WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_Bantuan_keywordSearchText'), 'Enervon')
...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/img_Bantuan_img-fluid'))
