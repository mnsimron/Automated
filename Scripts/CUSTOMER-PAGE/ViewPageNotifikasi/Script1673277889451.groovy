...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/i_Bantuan_la la-bell'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Lihat Semua Notifikasi'))
