...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Proposal'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/li_Riwayat'))
