...
WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_Bantuan_keywordSearchText'), 'archprobe')
...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/img_Tambah Ke Keranjang_cover'))
