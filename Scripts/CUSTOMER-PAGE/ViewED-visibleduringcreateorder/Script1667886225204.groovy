...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/i_ID Pelanggan dan Kata Sandi yang Anda mas_a72bd0'))

WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_ID Pelanggan dan Kata Sandi yang Anda_6edaa2'), 
    'Qwerty"12')
...
WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_Produk_keywordSearchText'), 'arch probe')

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/ngb-highlight_ARCH PROBE CONDITIONING'))
