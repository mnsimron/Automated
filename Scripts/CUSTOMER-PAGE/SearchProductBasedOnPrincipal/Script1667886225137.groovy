...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/div_Lihat Semua Rekanan'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/img_Rekanan APL_cover_1'))
