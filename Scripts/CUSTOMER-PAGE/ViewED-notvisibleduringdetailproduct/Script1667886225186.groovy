...
WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_Bantuan_keywordSearchText'), 'arch probe')

WebUI.sendKeys(findTestObject('Object Repository/Page_APL Customer Portal/input_Bantuan_keywordSearchText'), Keys.chord(
        Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/img_Katalog Produk_cover'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/div_APL Customer PortalARCH PROBEARCH PROBE_1bb274'))
