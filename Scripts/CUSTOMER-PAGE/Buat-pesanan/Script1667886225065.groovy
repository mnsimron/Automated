...
WebUI.setText(findTestObject('Object Repository/Page_APL Customer Portal/input_Produk_keywordSearchText'), 'danah')

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/button_NATUR E HBL 100 ML'))
