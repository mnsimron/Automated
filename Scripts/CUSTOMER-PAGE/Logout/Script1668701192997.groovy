...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_DUTA AGUNG. AP'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_DUTA AGUNG. AP'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Logout'))
