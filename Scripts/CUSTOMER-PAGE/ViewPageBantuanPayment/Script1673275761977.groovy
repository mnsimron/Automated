...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Bantuan'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/div_Talk to Us'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/button_Payment'))
