...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/a_Program'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/p_Diskon 1000'))
