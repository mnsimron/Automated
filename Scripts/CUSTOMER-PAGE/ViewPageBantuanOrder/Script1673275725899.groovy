...
WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/button_Order'))

WebUI.click(findTestObject('Object Repository/Page_APL Customer Portal/img'))
